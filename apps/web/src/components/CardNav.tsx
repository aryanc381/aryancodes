    ...
    <div className={`card-nav-container ${className}`}>
      <nav ref={navRef} className={`card-nav ${isExpanded ? 'open' : ''}`} style={{ backgroundColor: baseColor }}>
        <div className="card-nav-top">
          <div
            className={`md:hidden hamburger-menu ${isHamburgerOpen ? 'open' : ''}`}
            onClick={toggleMenu}
            role="button"
          ...
          >
            <div className="md:hidden hamburger-line" />
            <div className="md:hidden hamburger-line" />
          ...
          <div className="logo-container md:font-normal font-medium">
            <p>{logo}</p>
          </div>
          ...
          {(items || []).map((item, idx) => (
            ...
            >
              <div className="flex items-center gap-[2vw]">
                <GoArrowUpRight className="mt-[0.5vw] size-[4vw]" aria-hidden="true" />
