    ...
    return(
        <div className="flex font-semibold items-center md:font-medium mb-[3vw] pt-[3vw] pb-[3vw] pl-[3vw] pr-[4vw] md:mt-[1vw] md:mb-[0.5vw] justify-between rounded-md md:pb-[1.25vw] bg-[#2b2b2b] text-white md:p-[1vw]">
            <div className="flex flex-col">
                <TextAnimate animation='slideLeft' className='text-[4vw] md:text-[1.75vw]'>{role}</TextAnimate>
                <TextAnimate animation='slideLeft' className='text-[3vw] md:text-[2vw]'>{company}</TextAnimate>
            </div>
            <div className="flex flex-col text-end">
                <TextAnimate animation='slideLeft' className='md:text-[1.75vw]'>{time}</TextAnimate>
